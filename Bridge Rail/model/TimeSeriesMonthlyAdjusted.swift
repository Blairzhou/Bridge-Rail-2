...
//  Bridge Rail
//
//  Created by Blair Zhou on 10/5/21.
//
    ...
    func getMonthInfos() -> [MonthInfo] {
        ...
        for (dateString, ohlc) in sortedTimeSeries {
            ...
            guard let date = dateFormatter.date(from: dateString),
                  ...
                  let adjusedClose = ohlc.adjustedClose.toDouble() else { return [] }
            
            let monthInfo = MonthInfo(date: date, adjustedOpen: adjustedOpen, adjustedClose: adjusedClose)
